...
console.log(media2.matches);
console.log(media3.matches);
...
again.addEventListener('click', function () {
  ...
  if (media.matches) {
    ...
    againMoveElem(rockBtn, '46rem', '-8rem');
    againMoveElem(paperBtn, '30rem', '-23rem');
    againMoveElem(scissorsBtn, '40rem', '-23rem');
  }
